...
angular.module('AtlasPPS').controller('approvalPurchaseController',
    ...
    function ($scope, $rootScope, localStorageService, $location, notificationService, authService, ledgerService, transactionService, ngAuthSettings, DTOptionsBuilder, PpsConstant, $window, approvalService) {
        ...
        var getUnapprovedPurchaseTransactionList = function () {
            authService.loadingOn();
            var promise = transactionService.getUnapprovedPurchaseTransactionList(fiscalYear, companyId);
            promise.then(function (response) {
        ...
        var pageLoad = function () {
            ...
            getUnapprovedPurchaseTransactionList();
