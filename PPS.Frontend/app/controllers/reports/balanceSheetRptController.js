...
angular.module('AtlasPPS').controller('balanceSheetRptController',
    ['$scope', '$rootScope', 'localStorageService', 'notificationService', '$location', 'authService', 'balanceSheetRptService', 'ngAuthSettings', 'PpsConstant', '$window', 'DTOptionsBuilder',
        function ($scope, $rootScope, localStorageService, notificationService, $location, authService, balanceSheetRptService, ngAuthSettings, PpsConstant, $window, DTOptionsBuilder) {
            ...
            $scope.GetBalanceSheet = function () {
                ...
                var promise = balanceSheetRptService.GetBalanceSheet(vm);
            ...
            $scope.BalanceSheetReport = function (id) {
                ...
                popupWin.document.write('<html><head><link rel="stylesheet" type="text/css" href="../../css/bootstrap.css" /></head>' +
                    ...
                    '<h3 class="font-bold"><u>Balance Sheet Report</u></h3></div></div>' +
            ...
            var pageLoad = function () {
                ...
                if ($rootScope.isAuthenticated('306') === false) {
