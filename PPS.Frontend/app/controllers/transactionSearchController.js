...
angular.module('AtlasPPS').controller('transactionSearchController',
    ...
    function ($scope, $rootScope, localStorageService, $location, notificationService, authService, ledgerService, transactionService, ngAuthSettings, DTOptionsBuilder, PpsConstant, $window, approvalService) {
        ...
        $scope.getTransactionByTransactionNo = function () {
            authService.loadingOn();
            var promise = transactionService.getTransactionByTransactionNo(fiscalYear, companyId, $scope.transactionNo);
