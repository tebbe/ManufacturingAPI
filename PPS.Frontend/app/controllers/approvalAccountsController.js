...
angular.module('AtlasPPS').controller('approvalAccountsController',
    ['$scope', '$rootScope', 'localStorageService', '$location', 'notificationService', 'authService', 'ledgerService', 'transactionService', 'ngAuthSettings', 'DTOptionsBuilder', 'PpsConstant', '$window', 'approvalService','reportSettings',
        function ($scope, $rootScope, localStorageService, $location, notificationService, authService, ledgerService, transactionService, ngAuthSettings, DTOptionsBuilder, PpsConstant, $window, approvalService, reportSettings) {
        ...
        $scope.closeVerifyModal = function () {
            ...
            $('#transactionVerifyModal').modal('toggle');
        };

        $scope.verifyTransactionClick = function (tran) {
            selectedTransaction = tran;
            $('#transactionVerifyModal').modal({
                backdrop: 'static',
                keyboard: false
            });
        };
        ...
        var getUnapprovedAccountsTransactionList = function () {
            authService.loadingOn();
            var promise = transactionService.getUnapprovedAccountsTransactionList(fiscalYear, companyId);
            promise.then(function (response) {
